...
DeeperRelation = _reflection.GeneratedProtocolMessageType('DeeperRelation', (_message.Message,), dict(
...
Root = _reflection.GeneratedProtocolMessageType('Root', (_message.Message,), dict(
  ...
  InlineEmbedding = _reflection.GeneratedProtocolMessageType('InlineEmbedding', (_message.Message,), dict(

    NestedEmbedding = _reflection.GeneratedProtocolMessageType('NestedEmbedding', (_message.Message,), dict(
